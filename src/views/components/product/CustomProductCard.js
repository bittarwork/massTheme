      ...
      this.shadowRoot.innerHTML = `
       <head>
         ...
         .custom-product-card-add-to-cart-btn {
             ...
             margin-top: 16px;
             align-self: center; /* يجعل الزر في المنتصف عرضيا */
             width: auto; /* يحدد عرض الزر حسب المحتوى فقط */
        ...
        <div class="custom-product-card">
          ...
          <div class="custom-product-card-content">
            ...
            <button class="custom-product-card-add-to-cart-btn" aria-label="Add to wishlist" onclick="salla.wishlist.toggle(${this.product.id})">أضف الى السلة</button>
          </div>
